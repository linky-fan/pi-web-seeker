...
Browser                Next.js Server              AgentSession (in-process)
  ...
  |                        |   stored override -> ModelRuntime credential store
