...
function UserMessageViewImpl({ message, entryId, onFork, forking, onNavigate, prevAssistantEntryId, onEditContent }: {
  message: UserMessage;
  entryId?: string;
  ...
  const { copied, copy: copyContent } = useCopyFeedback(content);
...
export const UserMessageView = memo(UserMessageViewImpl);
