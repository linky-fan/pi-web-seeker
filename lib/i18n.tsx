...
const en: Record<string, string> = {
  ...
  "chat.contextHint.deepseekV4Pro": "DeepSeek V4 Pro: local needle test passed at ~990k prompt tokens; compact near 900k+ or before expensive follow-ups.",
  "chat.contextHint.minimaxM3": "MiniMax M3: local test passed 128k, was partial at 256k, timed out at 384k/512k, and rejected 900k; 1M is not verified here, so compact early around 128k-256k.",
  "chat.contextHint.generic": "Compact before the context window is crowded or before a costly follow-up.",
...
const zhCN: Record<string, string> = {
  ...
  "chat.contextHint.deepseekV4Pro": "DeepSeek V4 Pro：本地 needle 测试约 990k prompt tokens 通过；建议 900k 以后或高成本 follow-up 前压缩。",
  "chat.contextHint.minimaxM3": "MiniMax M3：本地测试 128k 通过，256k 部分通过，384k/512k 超时，900k 被拒绝；这里未验证 1M 可用，建议 128k-256k 附近提前压缩。",
  "chat.contextHint.generic": "上下文接近拥挤或准备进行高成本 follow-up 前建议压缩。",
