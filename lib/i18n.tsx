...
const en: Record<string, string> = {
  ...
  "chat.placeholder.streamingQueued": "Steer now / queue a follow-up...",
  "chat.placeholder.running": "Agent is running...",
  "chat.placeholder.message": "Message...",
  "chat.steer": "Steer",
  "chat.steerTitle": "Interrupt the running agent and inject this message now",
...
const zhCN: Record<string, string> = {
  ...
  "chat.placeholder.streamingQueued": "Steer 立即注入 / Follow-up 排队...",
  "chat.placeholder.running": "智能体正在运行...",
  "chat.placeholder.message": "输入消息...",
  "chat.steer": "Steer",
  "chat.steerTitle": "打断智能体当前运行，立即注入消息",
  "chat.followUp": "Follow-up",
