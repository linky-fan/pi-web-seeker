...
const en: Record<string, string> = {
  ...
  "explorer.insertPathPrompt": "Read this project-relative file directly: `{path}`.",
  "explorer.insertAbsolutePathPrompt": "Read this file directly: `{path}`.",
...
const zhCN: Record<string, string> = {
  ...
  "explorer.insertPathPrompt": "请直接读取项目目录下的文件：`{path}`。",
  "explorer.insertAbsolutePathPrompt": "请直接读取这个文件：`{path}`。",
