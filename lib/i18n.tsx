...
const en: Record<string, string> = {
  ...
  "chat.contextHint.minimaxM3": "MiniMax M3: local test passed 128k, was partial at 256k, timed out at 384k/512k, and rejected 900k; compact early around 128k-256k.",
...
const zhCN: Record<string, string> = {
  ...
  "chat.contextHint.minimaxM3": "MiniMax M3：本地测试 128k 通过，256k 部分通过，384k/512k 超时，900k 被拒绝；建议 128k-256k 附近提前压缩。",
